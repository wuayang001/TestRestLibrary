...
namespace TestRestLibrary
{
    ...
    {
        [DataMember]
        public LibraryServerResult SetReaderInfoInfoResult { get; set; }
        [DataMember]
    ...
    public class ReturnResponse
    {
        ...
        [DataMember]
        public string strpublicputReaderBarcode { get; set; }
        [DataMember]
    ...
    [DataContract]
    public class GetStatisInfoRequest
    {
        [DataMember]
        public string strDateRangeString { get; set; }
    }

    [DataContract]
    public class GetStatisInfoResponse
    {
        [DataMember]
        public LibraryServerResult GetStatisInfoResult { get; set; }

        [DataMember]
        public RangeStatisInfo info { get; set; }
